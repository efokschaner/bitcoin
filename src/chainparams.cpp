...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 2 * 60 * 60; // two days
        consensus.nPowTargetSpacing = 2 * 60; // two minutes
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 1916; // 95% of 2016
        consensus.nMinerConfirmationWindow = 10080; // 2 weeks / nPowTargetSpacing
        ...
        const char* pszTimestamp = "The Sunday Times 7/Feb/2021 Online giants face tax raid on booming sales";
        const CScript genesisOutputScript = CScript() << ParseHex("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
        genesis = CreateGenesisBlock(pszTimestamp, genesisOutputScript, 1612693851, 3366444448, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000000053afaaf244f13facf315511f28d353442b4c52170c2dde45a57ecbef"));
        assert(genesis.hashMerkleRoot == uint256S("0x1855e1c0da8713129ec7c0bd629a298c2108e87fb7bebeb0e86c426047fe95f7"));
        ...
        vSeeds.emplace_back("seed.nosellonlyhold.com");
        

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,40);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,8);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,100);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x13, 0x69, 0xBA, 0xAD};
        base58Prefixes[EXT_SECRET_KEY] = {0x13, 0x69, 0xB0, 0x01};
